/*
	...
	the light version, modified by nurazur@gmail.com 2018
    
    Heavy version is on https://github.com/Risele/SHT3x
	...
	Supports:
		Temperature data at Celsius scale.
...
*/
	...
	struct CalibrationFactors
	{
		...
		SHT3x(SoftwareWire*, int Address = 0x44, SHT3xSensor SensorType = SHT30);
		void Begin();
		void UpdateData();
        void GetData();
		...
		void SoftReset();
		void HardReset(uint8_t HardResetPin);

...
/****************************************************************/
const BME280b::Settings& BME280b::getSettings() const
{
   return m_settings;
}
...
/****************************************************************/
void BME280b::CalculateRegisters
(
   uint8_t& ctrlHum,
   uint8_t& ctrlMeas,
   uint8_t& config
...
/****************************************************************/
float BME280b::CalculateTemperature
(
   int32_t raw,
   int32_t& t_fine,
   TempUnit unit
...
/****************************************************************/
float BME280b::CalculateHumidity
(
   int32_t raw,
   int32_t t_fine
)
...
/****************************************************************/
float BME280b::CalculatePressure
(
   int32_t raw,
   int32_t t_fine,
   PresUnit unit

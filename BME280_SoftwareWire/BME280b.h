...
/*****************************************************************/
   ...
   //////////////////////////////////////////////////
   /// Read the temperature from the BME280b and return a float.
   float temp(
      TempUnit unit = TempUnit_Celcius);

   /////////////////////////////////////////////////////////////////
   /// Read the pressure from the BME280b and return a float with the
   /// specified unit.
   float pres(
      PresUnit unit = PresUnit_Pa);

   /////////////////////////////////////////////////////////////////
   /// Read the humidity from the BME280b and return a percentage
   /// as a float.
   float hum();

   /////////////////////////////////////////////////////////////////
   /// Read the data from the BME280b in the specified unit.
   void   read(
      float&    pressure,
      float&    temperature,
      float&    humidity,
...
/*****************************************************************/
   ...
   //////////////////////////////////////////////////////////////////
   /// Write configuration to BME280b, return true if successful.
...
/*****************************************************************/
   ...
   /////////////////////////////////////////////////////////////////
   /// Write values to BME280b registers.
   virtual bool WriteRegister(
      uint8_t addr,
      uint8_t data)=0;

   /////////////////////////////////////////////////////////////////
   /// Read values from BME280b registers.
